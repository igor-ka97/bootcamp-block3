...
<form class="search-filter" id="catalog-page__search-filter-1" method="GET" action="catalog.php">
	...
	<span class="search-filter__item">
		...
		<input class="search-filter__input" step="0.01" type="number" min="0" name="price_from" id="price-from" <?=(isset($correct_param['price_from'])) ? 'value="'.$correct_param['price_from'].'"': ''?> placeholder="от">
	</span>
	<span class="search-filter__item">
		<label class="search-filter__label" for="price-to">—</label>
		<input class="search-filter__input" step="0.01" type="number" min="0" name="price_to" id="price-to" <?=(isset($correct_param['price_to'])) ? 'value="'.$correct_param['price_to'].'"': ''?> placeholder="до">
	</span>
